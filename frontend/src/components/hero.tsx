    ...
    <section className="relative px-4 pt-16 pb-0 sm:px-6 md:pt-18">
      <div className="relative mx-auto w-full max-w-7xl overflow-hidden rounded-3xl bg-gradient-to-b from-pink-500 via-red-600 to-red-700 px-6 py-20 sm:px-10 md:py-20">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          >
            Build your resume and practice with AI-powered voice interviews.
          ...
          >
            <Link
              to="/dashboard"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-neutral-50 px-6 py-3 text-sm font-semibold text-neutral-950 hover:bg-white transition-colors"
            >
              Build Resume
            ...
            <Link
              to="/interview"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white/10 border border-white/20 px-6 py-3 text-sm font-semibold text-white hover:bg-white/20 transition-colors"
            >
              Start Interview
